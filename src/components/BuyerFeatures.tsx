        ...
        <div className="md:w-1/2 flex justify-center">
          <div className="relative">
            ...
            <div className="absolute top-0 right-0 md:-right-20 bg-white rounded-xl p-6 shadow-lg max-w-xs">
              ...
              <p>Since sellers can charge their own prices, and food is homemade, you will find prices much cheaper and healthier</p>
            </div>
            ...
            <div className="absolute top-1/3 right-0 md:-right-20 bg-white rounded-xl p-6 shadow-lg max-w-xs mt-8">
              ...
              <p>Homemade food is much healthier and tastier, why not also be cheaper and build new connections!</p>
            </div>
            ...
            <div className="absolute bottom-0 right-0 md:-right-20 bg-white rounded-xl p-6 shadow-lg max-w-xs">
              ...
              <p>Build connections with local chefs who can cook for you and list unique dishes on ICanCook</p>
            </div>
          </div>
        </div>
      </div>
