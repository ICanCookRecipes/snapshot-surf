...
const BuyerFeatures: React.FC = () => {
  return (
    <section id="buyer" className="feature-section pb-20">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 flex justify-center">
          <div className="relative w-full max-w-md h-auto min-h-[800px]">
            <img 
              src="/lovable-uploads/ee998a3f-3e36-410b-9b1b-682869a49535.png"
              alt="ICanCook App Buyer Dashboard"
              className="max-w-[90%] md:max-w-full h-auto relative z-10 mx-auto rounded-xl shadow-lg"
            />
            ...
            <div className="absolute bottom-[40%] left-[10%] md:left-[0%] w-[100px] md:w-[120px] h-[2px] bg-icancook-green z-5"></div>
            ...
            {/* Third card - Browse Listings */}
            <Card className="absolute bottom-[25%] left-[-80px] md:left-[-150px] max-w-[250px] z-20 feature-card transform hover:scale-105 transition-all">
              <CardContent className="p-4">
                <div className="flex items-center mb-2">
